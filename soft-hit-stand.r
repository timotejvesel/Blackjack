...
igralec_str <- function(igr_roka, hit) {
  ...
  while (stand != TRUE) {
    ...
    element <- hit.stand[vrstica, stolpec] ##### mislim, da je tu hit.stand pravilno
...
soft1[c("21","20","19"),] <- "S" # ce je vsota 21 (as + 10), ne bomo vzeli nove karte
...
save(soft1,file="soft-pravilna.Rda")
